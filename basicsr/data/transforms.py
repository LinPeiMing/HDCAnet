...
def unpaired_random_crop(img_gts, gt_patch_size, scale, gt_path):
...
def paired_random_crop_hw2(img_gts, img_lqs, gt_patch_size_h, gt_patch_size_w, scale, gt_path):
    """Paired random crop.
