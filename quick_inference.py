...
def parse_options(is_train=True):
    ...
    parser.add_argument('--input_l_path', type=str, required=True, help='Flickr1024/0001/lr0.png')
    parser.add_argument('--input_r_path', type=str, required=True, help='Flickr1024/0001/lr1.png')
    parser.add_argument('--output_l_path', type=str, required=True, help='Flickr1024/0001/sr0.png')
    parser.add_argument('--output_r_path', type=str, required=True, help='Flickr1024/0001/sr1.png')
