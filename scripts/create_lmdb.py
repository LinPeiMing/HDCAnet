...
def create_lmdb_for_div2k():
    ...
    """
    # HR images
    folder_path = '/media/li547/LinPeiMing/Dataset/work2/trainset_cheat/HHRR'
    lmdb_path = '/media/li547/LinPeiMing/Dataset/work2/trainset_cheat/HHRR.lmdb'
...
#################################################################################
    # LRx4 images
    # folder_path = '/media/li547/LinPeiMing/Dataset/work2/Real_stereo_test2(15)/Flickr1024RS/LLRR_x4'
    # lmdb_path = '/media/li547/LinPeiMing/Dataset/work2/Real_stereo_test2(15)/Flickr1024RS/LLRR_x4.lmdb'
    # img_path_list, keys = prepare_keys_div2k(folder_path)
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
